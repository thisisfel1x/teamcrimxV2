...
public class ZombieEquipment {
    ...
    private ItemStack[] swords = {
            ...
            new ItemBuilder(org.bukkit.Material.WOOD_SWORD).addEnchant(org.bukkit.enchantments.Enchantment.DAMAGE_ALL, 2).toItemStack(),
            new ItemBuilder(org.bukkit.Material.STONE_SWORD).addEnchant(org.bukkit.enchantments.Enchantment.DAMAGE_ALL, 1).toItemStack(),
            new ItemBuilder(org.bukkit.Material.GOLD_SWORD).addEnchant(org.bukkit.enchantments.Enchantment.DAMAGE_ALL, 1).toItemStack()
    ...
    private ItemStack[] helmets = {
            ...
            new ItemBuilder(org.bukkit.Material.GOLD_HELMET).addEnchant(org.bukkit.enchantments.Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack(),
    ...
    private ItemStack[] chestplates = {
            ...
            new ItemBuilder(org.bukkit.Material.GOLD_LEGGINGS).addEnchant(org.bukkit.enchantments.Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack(),
    ...
    private ItemStack[] leggins = {
            ...
            new ItemBuilder(org.bukkit.Material.GOLD_BOOTS).addEnchant(org.bukkit.enchantments.Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack(),
    ...
    private ItemStack[] shoes = {
            ...
            new ItemBuilder(org.bukkit.Material.GOLD_CHESTPLATE).addEnchant(org.bukkit.enchantments.Enchantment.PROTECTION_ENVIRONMENTAL, 1).toItemStack(),
